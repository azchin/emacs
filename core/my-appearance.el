...
(defun visual-lines() (interactive) (setq-local display-line-numbers 'visual) (visual-line-mode))
...
(defun visual-lines-type() (setq display-line-numbers-type 'visual) (visual-line-mode))
