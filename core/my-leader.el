...
;; (defun ido-read-project-desktop ()
;;   (interactive)
;;   (let ((ido-enable-replace-completing-read t))
;;     (call-interactively 'read-project-desktop))))
(ido-replace-completing-read-gen read-project-desktop)
(evil-define-key leader-states 'global (kbd "<leader> e p") 'ido-read-project-desktop)
...
(evil-define-key leader-states 'global (kbd "<leader> p f") 'ido-project-find-file)
(evil-define-key leader-states 'global (kbd "<leader> p g") 'project-find-regexp)
(evil-define-key leader-states 'global (kbd "<leader> p d") 'ido-project-dired)
(evil-define-key leader-states 'global (kbd "<leader> p v") 'ido-project-vc-dir)
(evil-define-key leader-states 'global (kbd "<leader> p e") 'ido-project-eshell)
(evil-define-key leader-states 'global (kbd "<leader> p c") 'ido-project-compile)
(evil-define-key leader-states 'global (kbd "<leader> p b") 'ido-project-switch-to-buffer)
(evil-define-key leader-states 'global (kbd "<leader> p p") 'ido-project-switch-project)
(evil-define-key leader-states 'global (kbd "<leader> p k") 'ido-project-kill-buffers)
(evil-define-key leader-states 'global (kbd "<leader> p R") 'ido-project-forget-project)
