...
(evil-define-key 'normal 'global (kbd "[ c") 'previous-error)
(evil-define-key 'normal 'global (kbd "] c") 'next-error)
(evil-define-key 'normal 'global (kbd "<leader> c a") 'modus-themes-toggle)
...
(evil-define-key 'normal 'global (kbd "<leader> f r") (lambda () (interactive) (find-file (read-file-name "Find file: " "~/drive"))))
...
(evil-define-key 'normal 'global (kbd "<leader> f e p") (lambda () (interactive) (find-file (emacsd "core/stagetwo.el"))))
...
(evil-define-key 'normal 'global (kbd "<leader> d r") (lambda () (interactive) (dired (concat home-dir "drive"))))
...
;; (evil-define-key 'normalglobal (kbd "<leader> d g") 'dired)
...
(evil-define-key 'normal 'global (kbd "<leader> n n") 'make-frame-command)
...
(evil-define-key 'normal 'global (kbd "<leader> n e") 'create-eshell-window)
...
(evil-define-key 'normal 'global (kbd "<leader> 1") 'shell-command)
...
(evil-define-key 'normal org-mode-map (kbd "<leader> o s") 'org-edit-src-code)
...
(evil-define-key 'normal org-mode-map (kbd "<leader> o r") 'org-occur)
