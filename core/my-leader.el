...
(evil-define-key leader-rw-states 'global (kbd "<leader> c e")
  (lambda () (interactive)
    (if mark-active
      ...
      (progn
        (while (condition-case nil (backward-up-list)
                 (:success t)
                 (scan-error nil))
          nil)
...
(evil-define-key 'normal 'global (kbd "<leader> c g") (lambda () (interactive) (kill-ring-save (point-min) (point-max))))
...
(evil-define-key 'normal org-mode-map (kbd "<leader> o c") 'org-edit-src-code)
...
(evil-define-key 'normal org-mode-map (kbd "<leader> o s s") 'org-occur)
(evil-define-key 'normal org-mode-map (kbd "<leader> o s s") (lambda () (interactive) (org-occur "\\[\\[.*\\]\\[.*\\]\\]")))
