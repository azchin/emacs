...
(evil-define-key leader-states 'global (kbd "<leader> c f") 'text-scale-adjust)
...
(evil-define-key leader-states 'global (kbd "<leader> f c a") (lambda () (interactive) (find-file (emacsd "core/appearance.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c b") (lambda () (interactive) (find-file (emacsd "core/buffer.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c p") (lambda () (interactive) (find-file (emacsd "packages.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c i") (lambda () (interactive) (find-file (emacsd "init.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c k") (lambda () (interactive) (find-file (emacsd "leader.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c l") (lambda () (interactive) (find-file (emacsd "core/late.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c m") (lambda () (interactive) (find-file (emacsd "core/modeline.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c t") (lambda () (interactive) (find-file (emacsd "core/tabs.el"))))
(evil-define-key leader-states 'global (kbd "<leader> f c o") (lambda () (interactive) (find-file (emacsd "core/org.el"))))
...
(evil-define-key leader-states 'global (kbd "<leader> f s l") (lambda () (interactive) (create-new-frame "*lisp-scratch*" 'lisp-interaction-mode)))
...
(evil-define-key leader-states 'global (kbd "<leader> n b") 'list-buffers)
...
(evil-define-key leader-states 'global (kbd "<leader> q q") (lambda () (interactive) (cond ((> (length (tab-bar-tabs)) 1) (tab-close))
